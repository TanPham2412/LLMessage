...
class NotificationController {
    ...
    initializeRoutes() {
        ...
        this.router.get("/unread-count", async function(req, res) {
            try {
                var userId = req.user.id;
        ...
        this.router.put("/:notificationId/read", async function(req, res) {
            try {
        ...
        this.router.put("/mark-all-read", async function(req, res) {
            try {
                var userId = req.user.id;
        ...
        this.router.delete("/:notificationId", async function(req, res) {
            try {
                var { notificationId } = req.params;
                var userId = req.user.id;
        ...
        this.router.delete("/", async function(req, res) {
            try {
                var userId = req.user.id;
        ...
        this.router.post("/report", async function(req, res) {
            try {
                ...
                if (self.socketHandler) {
                    admins.forEach(function(admin) {
                        self.socketHandler.sendNotificationToUser(admin._id.toString(), 'new-report', {
                            title: title,
                            message: message,
...
module.exports = notificationController.getRouter();
module.exports.setSocketHandler = notificationController.setSocketHandler.bind(notificationController);
