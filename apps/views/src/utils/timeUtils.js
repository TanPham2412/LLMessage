class TimeUtils {
  ...
  static getOnlineStatus(user, isOnline) {
    if (isOnline) {
      return { text: 'Đang hoạt động', className: 'online' };
    }
    
    return { text: TimeUtils.getTimeAgo(user.lastSeen), className: 'offline' };
  }
}

export const getTimeAgo = TimeUtils.getTimeAgo;
export const getOnlineStatus = TimeUtils.getOnlineStatus;
